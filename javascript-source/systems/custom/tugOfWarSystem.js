(function () {
    ...
    var voteLight = ['#lightside','#light','lightside','light'],
            voteDark = ['#darkside','#dark','darkside','dark'],
            min = -10000,
            max = 10000;
    ...
    $.bind('twitchBits', function(event) {
        ...
        //handle Lightside
        if (handleMessage(userMessage, voteLight)){
        ...
        //handle Darkside
        else if (handleMessage(userMessage, voteDark)){
            bitsCount = bitsCount - bits;
            if (bitsCount < -10000){
                bitsCount = -10000;
            }
    ...
    $.bind('initReady', function () {
        if ($.bot.isModuleEnabled('./systems/custom/tugOfWarSystem.js')) {
            $.registerChatCommand('./systems/custom/tugOfWarSystem.js', 'tugofwarreset', 7);
