...
//                }
    ...
    $.bind('initReady', function() {
        if ($.bot.isModuleEnabled('./custom/bandomizerGame.js')) {
            $.registerChatCommand('./custom/bandomizerGame.js', 'bandomizer', 7); //Checks if you are in the list.
            $.registerChatCommand('./custom/bandomizerGame.js', 'banalooney', 2); //Times out a viewer and gives him one hour immunity.
            $.registerChatCommand('./custom/bandomizerGame.js', 'snap', 2); //Times out 5 viewers and gives him one hour immunity.
