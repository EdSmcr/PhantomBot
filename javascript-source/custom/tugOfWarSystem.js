(function () {
    ...
    $.bind('initReady', function () {
        if ($.bot.isModuleEnabled('./custom/tugOfWarSystem.js')) {
            $.registerChatCommand('./custom/tugOfWarSystem.js', 'tugofwarreset', 2);
            $.registerChatCommand('./custom/tugOfWarSystem.js', 'tugofwar', 2);
            init();
        }
    });
})();