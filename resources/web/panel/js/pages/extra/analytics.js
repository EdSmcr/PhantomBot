...
$(function() {
    ...
    let chartConfig = {"type": "line", "data": {"datasets": [{"data": [], "backgroundColor": []}], "labels": [] }, "options": {"responsive": false, "title": {"display": true}}},
        chartContext = $('#views-chart').get(0).getContext('2d'),
